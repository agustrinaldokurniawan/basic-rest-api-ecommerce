...
const transporter = nodemailer.createTransport({
  ...
  port: 587,
  auth: {
    user: "germaine.harris74@ethereal.email",
    pass: "7UzrNNxyHhA4GGj4MY",
  },
});
...
class EmailController {
  ...
  static async sendMail(req, res) {
    try {
      ...
      // {
      //     "destinationEmails":["agustkurniawan010899@gmail.com","agustkurniawan010899@gmail.com"],
      ...
      let info = await transporter
        .sendMail({
          ...
          to: destinationEmails.toString(), // list of receivers
          subject, // Subject line
          text, // plain text body
          html, // html body
        })
        .catch((_) => {
          return new Error("Error whle send mail");
        });

      // {
      //     "info": {
      //         "accepted": [
      //             "agustkurniawan010899@gmail.com"
      //         ],
      //         "rejected": [],
      //         "envelopeTime": 569,
      //         "messageTime": 206,
      //         "messageSize": 7826,
      //         "response": "250 Accepted [STATUS=new MSGID=YSj45rGQC1Z8NBe-YSj9iEoXdlatzeTmAAAABOjvOTRO0-8yaKUZ-0kQZR0]",
      //         "envelope": {
      ...
      //             ]
      //         },
      //         "messageId": "<af40555b-0879-16d4-38d1-37886f5273fe@example.com>"
      //     }
      // }
